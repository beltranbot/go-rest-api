...
func initDB() {
	...
	dataSourceName := "root:Root123!@tcp(localhost:3306)/godb?parseTime=True"
	...
	// Comment out if running multiple times - You may se an error otherwise
...
func deleteOrder(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	inputOrderID := params["orderId"]
	// Convert 'orderId' string params to uint64
	id64, _ := strconv.ParseUint(inputOrderID, 10, 64)
	// Convert uint64 to unit
